...
# 例としての結合率データとパラメータ
K_theoretical = np.array([0.10763251, 0.04857286, 0.04163505, 0.05321691, 0.06709525, 0.15075631, 0.6784616 ])  # 理論的な結合率
params = OptimizeKParams(
    L=np.array([6.20e-05, 6.20e-05, 7.75e-05, 7.75e-05, 7.75e-05, 7.75e-05]),
    n_g=4.4,
    n_eff=2.2,
    eta=0.996,
    alpha=52.96,
