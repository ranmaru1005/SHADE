...
# 例としての結合率データとパラメータ
K_theoretical = np.array([0.45630497, 0.07501402, 0.08411477, 0.0415256, 0.01651983, 0.07898464, 0.39775359])  # 理論的な結合率
params = OptimizeKParams(
    L=np.array([7.75e-05, 7.75e-05, 7.75e-05, 6.20e-05, 6.20e-05, 7.75e-05]),
    n_g=4.4,
    n_eff=2.2,
    eta=0.996,
    alpha=52.96,
