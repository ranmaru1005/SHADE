...
def SHADE(func, bounds, params, pop_size=15, max_iter=500, F=0.5, cr=0.7,  ftol=10**-8, callback=None, rng=None):
    ...
    best_x = populations[np.argmin(obj_list)]       #最もよい評価を得た際の解を記録する
...
def multSHADE(func, bounds, params, j, F, cr, pop_size, best_x, obj_list, populations, target, dims, rng):
    #mutation
...
def wrapper_multSHADE(args):
    return multSHADE(*args)
