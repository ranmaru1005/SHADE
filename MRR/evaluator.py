...
def _evaluate_ripple(
    ...
    print(f\"x[idx_start:idx_end].min() = {x[idx_start:idx_end].min():.3f}\")
    print(f\"x[idx_start:idx_end].max() = {x[idx_start:idx_end].max():.3f}\")
    print(f\"x[idx_start:idx_end][:5] = {x[idx_start:idx_end][:5]}\")
